...
private:
    ...
    std::array<double, 6>
        tool_vector_actual_; // Actual Cartesian coordinates of the tool:
    ...
    std::array<double, 6>
        tool_vector_target_; // Target Cartesian coordinates of the tool:
                             // (x,y,z,rx,ry,rz), where rx, ry and rz is a
                             // rotation vector representation of the tool
                             // orientation
    std::array<double, 6> tcp_speed_target_; // Target speed of the tool given
                                             // in Cartesian coordinates
    std::array<bool, 64>
        digital_input_bits_; // Current state of the digital inputs. NOTE: these
    ...
    std::array<double, 3>
        tool_accelerometer_values_; // Tool x,y and z accelerometer values
