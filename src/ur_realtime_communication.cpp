...
void UrRealtimeCommunication::setSpeed(const std::array<double, 6> & joint_speed, double acc)
{
  setSpeed(joint_speed[0], joint_speed[1], joint_speed[2], joint_speed[3], joint_speed[4], joint_speed[5], acc);
}
...
const std::string & UrRealtimeCommunication::getLocalIp()
{
  return local_ip_;
}
